...
//
        ...
        //insert
        final Button saveStudent = findViewById(R.id.BtnSave);
            ...
            public void onClick(View v) {
                ...
                dbRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()){
                            studentMaxId = (dataSnapshot.getChildrenCount());
                        }
                    }
                ...
                try {
                    if (TextUtils.isEmpty(txtID.getText().toString())){
                        ...
                        dbRef.child(String.valueOf(studentMaxId+1)).setValue(std);
        ...
        final Button showStudent = findViewById(R.id.BtnShow);
        ...
        //update
        final Button studentUpdate = findViewById(R.id.BtnUpdate);
        ...
        // delete
        final Button deleteStudent = findViewById(R.id.BtnDelete);
